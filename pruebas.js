...
function soloNumeros(array) {
  ...
  function numeroSimetrico(num) {
    ...
    const numInvertido = Number(num.toString().split('').reverse().join(''));
  ...
  function index() {
    ...
    var numeros = [5, 6, 4, 65, 8, 4];
      ...
      Array.prototype.encontraIndex = function( index ) {
  ...
  function crearClasePersona() {
    ...
    class Persona {
      ...
      getHobbies() {
        ...
        return this.hobbies.filter( x => x )
